...
import io.cdap.nlp.TextClassificationService;
...
public class TextClassification implements Directive {
  private static final Logger LOG = LoggerFactory.getLogger(TextClassification.class);
    ...
    for (Row row : rows) {
      ...
      if (value instanceof String) {
        ...
        throw new DirectiveExecutionException(
          String.format("Text classification can be applied only on a text field")
        );
      }
    }
    return rows;
